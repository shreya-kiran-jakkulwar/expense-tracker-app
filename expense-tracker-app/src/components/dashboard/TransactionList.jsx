          ...
          {recentTransactions.map((t) => {
            ...
            return (
              ...
              >
                ...
                {/* Amount */}
                <div className={`text-sm font-bold flex-shrink-0 ${isExpense ? 'text-red-400' : 'text-emerald-400'}`}>
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg text-theme-text-muted opacity-0 group-hover:opacity-100 hover:text-red-400 hover:bg-red-500/10 transition-all flex-shrink-0"
                  title="Delete"
                >
